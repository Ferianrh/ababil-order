        ...
        <div class="content mt-3">
            <div class="animated fadeIn">
                <div class="row">
                            ...
                            <div class="card-body">
                                <table id="basic-datatables" class="table table-striped table-bordered">
                                    ...
                                    <tbody>
                                        @foreach($data as $row)
                                        <tr>
                                            <td>{{$row->nama_jahit}}</td>
                                            <td>{{$row->deskripsi_jahit}}</td>
                                            <td>
                                                <button class="btn btn-success btn-sm " id="edit" href="{{route('jenis-jahit.update',$row->id_jahit)}}" data-nama="{{$row->nama_jahit}}" data-desc="{{ $row->deskripsi_jahit }}">
                                                    <i class="fa fa-edit"> </i>
                                                </button>
                                                <!-- <button href="{{route('jenis-jahit.destroy', $row->id_jahit)}}" class="btn btn-danger btn-sm" id="delete" data-title="{{ $row->nama_jahit }}">
                    ...
                    @include('admin.jenisJahit.create')
                    @include('admin.jenisJahit.edit')
                </div>
            </div><!-- .animated -->
        </div><!-- .content -->
    <!-- Right Panel -->
